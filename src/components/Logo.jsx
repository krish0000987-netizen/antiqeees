  ...
  return (
    <Link to="/" className="flex items-center gap-3 group text-decoration-none shrink-0">
      <div className="relative flex items-center justify-center shrink-0">
        {/* Decorative Gold Crest Circle with explicit size constraints */}
        <svg
          viewBox="0 0 100 100"
          width="44"
          height="44"
          className="h-11 w-11 text-[#c5a059] filter drop-shadow-[0_0_8px_rgba(197,160,89,0.4)] transition-transform duration-500 group-hover:scale-105 shrink-0"
        >
